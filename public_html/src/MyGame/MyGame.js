        ...
        switch(floor)
        {
            ...
            case 1:
                if(this.isMoving){
                    ...
                    if((xNow>this.chestPosition[0][0]-5)&&(xNow<this.chestPosition[0][0]+5)&&this.isChest1===false){
                         var xHero = this.mHero.mRenderComponent.mXform.mPosition[0];
                         var yHero = this.mHero.mRenderComponent.mXform.mPosition[1];
            ...
            case 2:
                if(this.isMoving){
                    ...
                    if((xNow>this.chestPosition[1][0]-5)&&(xNow<this.chestPosition[1][0]+5)&&this.isChest1===false){
                         var xHero = this.mHero.mRenderComponent.mXform.mPosition[0];
                         var yHero = this.mHero.mRenderComponent.mXform.mPosition[1];
                        this.mGun.mXform.mPosition[0] = xHero + 20;
                        this.mGun.mXform.mPosition[1] = yHero + 20;
                        ...
                        this.isChest1 = true;
                        this.isGun = 3;
                    }else if((xNow>this.chestPosition[2][0]-5)&&(xNow<this.chestPosition[2][0]+5)&&this.isChest1===false){
                         var xHero = this.mHero.mRenderComponent.mXform.mPosition[0];
                         var yHero = this.mHero.mRenderComponent.mXform.mPosition[1];
                        this.mGun.mXform.mPosition[0] = xHero + 20;
                        this.mGun.mXform.mPosition[1] = yHero + 20;
            ...
            case 3:
                ...
                if(this.isMoving && this.iskey===true){
                    if((xNow>-34)&&(xNow<-26)){
